...
export default function AboutPage() {
    return (
        <main className="mx-auto max-w-[1120px] px-4 md:px-6 pt-20 md:pt-16 space-y-20">
            {/* Back to Home */}
            <Link
                href="/"
            ...
            {/* Intro + stickers */}
            <section className="grid gap-10 md:grid-cols-[1.25fr_0.75fr] items-start md:pb-18 !mt-0">
                ...
                <div className="relative">
                    ...
                    <ol className="md:hidden flex flex-col items-center gap-4 px-4">
                        ...
                        <Step
                            ...
                            cardClassName="w-full"
                        >
                            Explore at your own pace. Obi helps you avoid scams, understand opportunities, and connect
            ...
            {/* Finals */}
            <section className="space-y-10 w-full max-w-[423px] mx-auto text-center" style={{marginBottom: 10 + 'rem'}}>
                <div>
                    <div className="gasoek text-[28px] md:text-[48px] leading-[1.18] tracking-[0.03em] text-[#ADC178]">
            ...
            {/* footer */}
            <footer className="relative mt-16 left-1/2 w-screen -translate-x-1/2">
