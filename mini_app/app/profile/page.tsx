  ...
  return (
    <main style={{ padding: 16, maxWidth: 420, margin: "0 auto" }}>
      ...
      <button
        ...
        style={{ width: "100%", textAlign: "left", padding: 16, borderRadius: 16, background: "#f4efdf", border: 0, marginBottom: 12 }}
      >
        Username
      </button>
      <button
        onClick={() => alert("Language picker TBD")}
        style={{ width: "100%", textAlign: "left", padding: 16, borderRadius: 16, background: "#f4efdf", border: 0 }}
      >
        Language
      </button>
